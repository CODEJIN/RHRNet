...
if __name__ == "__main__":
    audio = Audio_Prep("E:/musdb18hq/train/A Classic Education - NightOwl/bass.wav", 44100)
    spect = Spectrogram_Generate(audio, 44100, 1025, 1024, 256)
    import matplotlib.pyplot as plt

    plt.imshow(spect[:256].T, aspect= 'auto', origin='lower')
    plt.colorbar()
    plt.show()